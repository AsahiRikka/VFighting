...
public class VMotionDataGizmos : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        {
            if ((_currentFrame >= VARIABLE.segmentMotion.startFrame &&
                 _currentFrame <= VARIABLE.segmentMotion.endFrame) ||
                VARIABLE.segmentMotion.type == VSegmentMotionType.allskill) 
            {
