...
public class VSkillEventBase
{
    protected VSkillEventBase(VActorEvent actorEvent)
    {
        ...
        skillEvent.ActorHitToDefenceEvent.AddListener(HitToDefenceEvent);
        skillEvent.ActorDefenceEvent.AddListener(DefenceEvent);
    }
    ...
    protected virtual void HitToDefenceEvent(VSkillAction activeSkillAction, VSkillAction passiveSkillAction)
    {
        
    }
    
    protected virtual void DefenceEvent(VSkillAction activeSkillAction, VSkillAction passiveSkillAction)
    {
