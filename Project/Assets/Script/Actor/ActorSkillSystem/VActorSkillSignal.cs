...
public class VActorSkillSignal
{
    ...
    //AI控制器
    private VActorAIManager _aiManager;
        ...
        VActorInfo actorInfo, VActorState actorState)
    {
        ...
        EventManager.ActorInputEvent.Subscribe(InputSetEvent);
    }
    ...
    public void Init()
    {
        ...
        {
            _aiManager = new VActorAIManager(_actorEvent, _actorInfo.skillInfo, physicComponentDic, _skillActions,
                _actorState);
    ...
    public void Destroy()
    {
        ...
        EventManager.ActorInputEvent.RemoveEventHandler(InputSetEvent);
        _aiManager?.Destroy();
    }
    ...
    private void InputSetEvent(bool player1, bool player2)
    {
        if (_property.playerEnum == PlayerEnum.player_1)
        {
            InputSet(player1);
    ...
    private void InputSet(bool input)
    {
        canInput = input;
    }
}