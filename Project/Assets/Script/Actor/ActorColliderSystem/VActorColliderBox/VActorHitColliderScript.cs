...
public class VActorHitColliderScript : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            VActorDefenceColliderScript defenseScript = other.gameObject.GetComponent<VActorDefenceColliderScript>();
            PlayerEnum enemy = defenseScript.player;
            ...
            //攻击方通知
            EventManager.HitToDefenceEvent.BoradCastEvent(player, currentSkill, enemy, defenseScript.currentSkill);

            //受击方通知
            EventManager.DefenceToHitEvent.BoradCastEvent(enemy,defenseScript.currentSkill,player,currentSkill);
